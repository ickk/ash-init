...
/// A [`DebugCallback`] impl that prints any messages it receives to stderr.
pub struct PrintDebugCallback<const ENABLE_COLOR: bool = false> {
  message_severities: vk::DebugUtilsMessageSeverityFlagsEXT,
  message_types: vk::DebugUtilsMessageTypeFlagsEXT,
}

impl PrintDebugCallback {
  /// Create a new `PrintDebugCallback` that listens for messages matching the
  /// specified severities and types.
  ///
  /// You can use [`MessageSeverityFlags`][crate::debug::MessageSeverityFlags]
  /// and [`flags::MessageTypeFlags`][crate::debug::MessageTypeFlags] to
  /// populate these arguments instead of `vk::DebugUtilsMessage*FlagsEXT`.
  pub fn new(
    ...
    Box::new(PrintDebugCallback::<false> {
  ...
  pub fn new_color(
    ...
    Box::new(PrintDebugCallback::<true> {
      message_severities: message_severities.into(),
      message_types: message_types.into(),
    })
  }
...
impl<const ENABLE_COLOR: bool> DebugCallback
  for PrintDebugCallback<ENABLE_COLOR>
{
